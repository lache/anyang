...
class CCTexture2DMutable : public cocos2d::Texture2D
{
...
public:
	...
	bool initWithData(const void* data, Texture2D::PixelFormat pixelFormat, unsigned int pixelsWide, unsigned int pixelsHigh, const cocos2d::Size& contentSize);
    ...
    ///
    cocos2d::Texture2D* copyMutable(bool isMutable);
    
    CCTexture2DMutable* copy();
    
    void copy(CCTexture2DMutable* textureToCopy, const cocos2d::Point& offset);
